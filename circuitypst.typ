  ...
  group(
    name: name,
    {
      ...
      if v != none {
        assert(
          type(v) == "content" or (
            type(v) == "array" and i.len() == 2 and type(v.first()) == "string" and type(v.last()) == "content"
          ),
          message: "Invalid voltage syntax",
        )
      ...
      if i != none {
        assert(
          type(i) == "content" or (
            type(i) == "array" and i.len() == 2 and type(i.first()) == "string" and type(i.last()) == "content"
          ),
          message: "Invalid current label syntax",
        )
      ...
      if poles != none {
        if type(poles) == "string" {
          poles = (poles.first(), poles.last()).map(p => (
            "*": "circ",
            d: "diamondpole",
            s: "squarepole",
            o: "ocirc",
